class Рускрипт {
  ...
  #модификаторы_рускрипта = {
    ...
    вычесть: /^( и)? вычесть (.*?)((?=( и))(.*))?$/ui,
    умножить: /^( и)? умножить на (.*?)((?=( и))(.*))?$/ui,
    поделить: /^( и)? поделить на (.*?)((?=( и))(.*))?$/ui,
    остаток_от_деления: /^( и)? определить остаток от деления на (.+?)((?=( и))(.*))?$/ui,
  ...
  обработать(содержимое) {
    ...
    let команды = содержимое.split(/((?<!\/)\.)+/guim);
  ...
  обработать_модификаторы(модификаторы){
    ...
    if(модификаторы_рускрипта[i] == "вывести_на_экран"){
    ...
    } else if(модификаторы_рускрипта[i] == "вычесть"){
      let [,,значение,следующие_модификаторы] = this.#модификаторы_рускрипта[модификаторы_рускрипта[i]].exec(модификаторы)
      this.#_временно -= this.преобразовать_значение_для_операции(значение)
      последующие_модификаторы = следующие_модификаторы;
      ...
      this.#_временно /= this.преобразовать_значение_для_операции(значение)
      последующие_модификаторы = следующие_модификаторы;
    } else if(модификаторы_рускрипта[i] == "заменить"){
      let [,,что,на_что,следующие_модификаторы] = this.#модификаторы_рускрипта[модификаторы_рускрипта[i]].exec(модификаторы)
      ...
      последующие_модификаторы = следующие_модификаторы;
    } else if(модификаторы_рускрипта[i] == "остаток_от_деления"){
      let [,,делитель,следующие_модификаторы] = this.#модификаторы_рускрипта[модификаторы_рускрипта[i]].exec(модификаторы)
